...
$(document).ready(function(){   
    ...
    //春节倒计时
    var starttime = new Date("2024/1/21");
    setInterval(function () {
        ...
        $('.time').html("<p>新年倒计时</p>" + "<p><span>" + day + "</span>" + "天</p>");
        $(".sydate").html(syday);
    ...
    var mess = "<span>哈喽啊, 少年！！</span><span class='B-span2'>祝你，新年快乐！</span><span>Hello,  happy new year</span><span>新年我来了</span><span>哈哈哈哈</span>";
    $(".Barrage").append(mess);
    ...
    var this_url=window.location.href;
        ...
        wx.ready(function () {   //需在用户可能点击分享按钮前就先调用
            ...
            wx.updateAppMessageShareData({ 
                ...
                imgUrl: 'static/images/time.jpg', // 分享图标
                success: function () {
                    // alert("分享成功!");
                }
            });
